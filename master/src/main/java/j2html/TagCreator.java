...
public class TagCreator {
	 ...
	 * collection Intended usage: each(numbers, n -> li(n.toString()))
	 *
	 * @param collection
	 *            the collection to iterate over, ex: a list of values "1, 2, 3"
	 * @param mapper
	 *            the mapping function, ex: "n -> li(n.toString())"
	 * @return unsafeHtml containing mapped data (ex. docs:
	 *         <li>1</li>
	 *         <li>2</li>
	 *         <li>3</li>)
	 */
	 ...
	 * {@link j2html.TagCreator#each} Intended usage: each(filter(numbers, n ->
	 * n % 2 == 0), n -> li(n.toString()))
	 *
	 * @param collection
	 *            the collection to filter, ex: a list of values "1, 2, 3"
	 * @param filter
	 *            the filter predicate, ex: "n -> n % 2 == 0"
	...
	public static UnescapedText unsafeHtml(String html) {
